...
class _HomePageState extends State<HomePage> {
  ...
  final socialUrls = [
    ...
    'https://fr.linkedin.com/in/srikanth-collaty-9343a520b',
    'https://github.com/srikanthsc',
  ];
            ...
            children: [
              ...
              AnimatedTextKit(
                animatedTexts: [
                  ...
                  TyperAnimatedText('IT Engineer',
                      textStyle: AppTextStyles.montserratStyle(
                          color: Colors.lightBlue)),
                  TyperAnimatedText('Full-Stack Engineer',
                      textStyle: AppTextStyles.montserratStyle(
                          color: Colors.lightBlue))
                ],
          ...
          child: SizedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  onTap: () {
                    // Open the social media link when tapped
                    launch(socialUrls[index]);
                  },
                  onHover: (value) {
                    setState(() {
                      if (value) {
